        ...
        {boxes.map((box, index) => {
          ...
          return (
            <div
              ...
              border-3 border-[#2d4c2e] shadow-xl md:shadow-2xl flex flex-col items-start justify-end
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <a href="#" className="text-[#9dffa1] underline text-xs md:text-xl sm:text-sm hover:opacity-80 transition-opacity"> Learn More </a>
              </div>
            </div>
          );
        })}
