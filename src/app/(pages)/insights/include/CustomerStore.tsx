  ...
  return (
    <div ref={container} className="h-screen flex items-center justify-center sticky top-0">
      <motion.div
        ...
        className="relative flex flex-col w-[95vw] md:w-[670px] md:h-[420px] rounded-4xl shadow-2xl text-white overflow-hidden border-2 border-[#2d4c2e]"
      >
        {/* Background Blurs */}
        ...
        <div className="relative z-10 flex flex-col gap-3 p-8">
          <div>
            <p className="text-xs md:text-sm uppercase tracking-widest text-[#bebec0] font-semibold mb-2">
              {subtitle}
            </p>
            <h2 className="text-xl md:text-2xl font-bold text-[#fbfffd] leading-tight mb-2 h-10">{title}</h2>
...
const CustomerStore = () => {
    return (
        ...
        items-center justify-between text-white px-4 mt-5 md:mt-1 md:px-20 lg:px-20'>
            {/* Left Section */}
            <section className='flex flex-row'>
                <div className=''>
                        <div className="relative inline-block">
                            ...
                            {/* Button Content */}
                            <button type="button" className="relative inline-flex items-center gap-1 md:gap-3 lg:gap-2 bg-gray-950 pl-1 md:pl-1 pr-2 md:pr-5 py-1 md:py-1 rounded-full text-white text-xs md:text-sm font-medium backdrop-blur-sm m-0.5" >
                        ...
                        <p className='text-[#ffffff] text-2xl lg:text-5xl font-bold mt-4'>Stories of <span className='text-[#9dffa1]'>Impact</span></p>
                        <p className='text-[#ffffff] mt-4 text-sm md:text-base lg:text-lg'>
