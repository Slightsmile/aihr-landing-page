            ...
            <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center py-20">
                 <div className="mb-6 md:mb-8">
                    <div className="relative inline-block">
                        ...
                        <p
                        className="relative inline-flex items-center gap-2 md:gap-3 lg:gap-2 lg:w-32 lg:h-11 bg-gray-950
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-normal text-white mb-4 leading-tight text-center max-w-5xl">
                    Ideas and achievements <br/> <span className="text-[#9dffa1]">shaping</span>
                    the future.
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    {/* Apply Now Button */}
                    <button className="group inline-flex items-center gap-2 md:gap-3 p-[2px] rounded-full bg-gradient-to-r from-[#dcdedd] to-[#3eb343] transition-all duration-300 transform hover:scale-105 shadow-[0_0_20px_rgba(74,222,128,0.3)] hover:shadow-[0_0_30px_rgba(74,222,128,0.6)] hover:cursor-pointer">
