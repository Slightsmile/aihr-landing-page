    ...
    return (
        <div>
            ...
            <section className='relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center py-2'>
                ...
                <p className='text-white text-xl md:text-4xl xl:text-4xl font-bold'>Global <span className='text-[#9dffa1]'>Studies</span></p>
                <p className='text-[#bebec0] text-md md:text-2xl text-center'>Explore cutting-edge studies on digital transformation, <br />
