...
const GetInTouchSection = () => {
    return (
        <div className="space-y-6 md:space-y-8">
            {/* Badge */}
            <button className="group inline-flex items-center gap-2 md:gap-3 p-[2px] rounded-full  bg-gradient-to-r from-[#848484] to-[#056809] hover:shadow-lg hover:shadow-green-400/50 transition-all  duration-300 transform hover:scale-105">
                <span className="inline-flex items-center gap-2 md:gap-3 px-4 md:px-6 py-2 md:py-3 rounded-full bg-gray-950 text-[#ffffff] font-semibold text-xs md:text-sm lg:text-base">
            ...
            {/* Heading */}
            <div>
                <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold text-white mb-4 md:mb-6 leading-tight">
                    Get In <span className="text-[#9dffa1]">Touch</span>
                </h1>
                <p className="text-[#bebec0] text-base md:text-lg">
            ...
            <div className="space-y-3 md:space-y-4">
                {/* Email */}
                <div className="p-[1px] rounded-2xl bg-gradient-to-r from-[#a9aaa9] to-[#3d603f] cursor-pointer group">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2 md:gap-4 p-3 md:p-4 rounded-xl bg-gray-950">
                        <div className='flex flex-row gap-2 flex-1 min-w-0'>
                            
                        <div className="flex items-center justify-center w-10 md:w-12 h-10 md:h-12 rounded-lg bg-emerald-500/10 group-hover:bg-emerald-500/20 transition-colors flex-shrink-0">
                            <svg width="32" height="32" className="md:w-10 md:h-10" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="0.5" y="0.5" width="39" height="39" rx="9.5" stroke="#353535"/>
                                <path d="M25 11.5H15C12 11.5 10 13 10 16.5V23.5C10 27 12 28.5 15 28.5H25C28 28.5 30 27 30 23.5V16.5C30 13 28 11.5 25 11.5ZM25.47 17.59L22.34 20.09C21.68 20.62 20.84 20.88 20 20.88C19.16 20.88 18.31 20.62 17.66 20.09L14.53 17.59C14.21 17.33 14.16 16.85 14.41 16.53C14.67 16.21 15.14 16.15 15.46 16.41L18.59 18.91C19.35 19.52 20.64 19.52 21.4 18.91L24.53 16.41C24.85 16.15 25.33 16.2 25.58 16.53C25.84 16.85 25.79 17.33 25.47 17.59Z" fill="#9DFFA1"/>
                            </svg>

                        </div>
                        <div className='min-w-0'>
                            <p className='bg-gradient-to-r from-[#fdfdfd] to-[#999999] bg-clip-text text-transparent font-bold text-base md:text-lg lg:text-xl'>
                                 Email
                            </p>
                            <p className="text-[#ffffff] text-xs md:text-sm truncate">daffodil.rc@info.com</p>
                        </div>
                        </div>
                ...
                <div className="p-[1px] rounded-2xl bg-gradient-to-r from-[#a9aaa9] to-[#3d603f] cursor-pointer group">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2 md:gap-4 p-3 md:p-4 rounded-xl bg-gray-950">
                        ...
                        <div className='min-w-0'>
                            ...
                            <p className="text-white text-xs md:text-sm truncate">+880175555 5555</p>
                        </div>
                ...
                <div className="p-[1px] rounded-2xl bg-gradient-to-r from-[#a9aaa9] to-[#3d603f] cursor-pointer group">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2 md:gap-4 p-3 md:p-4 rounded-xl bg-gray-950">
                        ...
                        <div className='min-w-0'>
                            ...
                            <p className="text-white text-xs md:text-sm line-clamp-2">House No. 31, Road No. B-2, Block-L, Pallabi, Mirpur, DHaka</p>
                        </div>
