...
const Details = () => {
    return (
        <section className="py-20 px-4 md:px-8 lg:px-16 bg-[var(--light-bg)] relative overflow-hidden">
            <div className="absolute top-70 right-0 w-96 h-96 bg-blue-50/50 rounded-full blur-3xl"></div>
            <div className="absolute top-230 right-0 w-96 h-96 bg-amber-50/50 rounded-full blur-3xl"></div>
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[var(--primary-navy)] mb-6"><span className="text-[var(--accent-blue)]">SaaS & AI</span> Innovations Hub </h2>
                    <p className="text-[var(--charcoal)] text-lg md:text-xl lg:text-2xl max-w-4xl mx-auto leading-relaxed px-4"> Unleashing cutting-edge intelligence to redefine your digital frontier. </p>
                ...
                <div className='w-full max-w-7xl mx-auto px-4 md:px-8 '>
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 px-1 md:px-10'>
                        {/*  Card 1 & 2 */}
                        <div className='w-full h-auto lg:h-110 border border-gray-100 rounded-3xl overflow-hidden bg-[var(--card-bg)] shadow-lg flex flex-col relative'>

                            <div className='flex flex-col gap-4 mb-6 p-6 md:p-8 relative z-10'>
                                <h3 className=' text-2xl md:text-3xl font-bold text-[var(--primary-navy)]'>Cost Optimization</h3>
                                <p className='text-[var(--charcoal)] text-sm md:text-base leading-relaxed'>Our BPO services reduce overhead by up to 40%, leveraging skilled talent in cost-effective locations while maintaining 24/7 service quality. Pay only for what you need—no hidden costs, no infrastructure expenses.</p>
                            </div>
                        ...
                        <div className='w-full h-auto lg:h-110 border border-gray-100 rounded-3xl overflow-hidden bg-[var(--card-bg)] shadow-lg flex flex-col relative'>
                            ...
                            <div className='flex flex-col gap-4 mb-6 p-6 md:p-8 relative z-10'>
                                <h3 className='text-2xl md:text-3xl font-bold text-[var(--primary-navy)]'>Scalable Expertise</h3>
                                <p className='text-[var(--charcoal)] text-sm md:text-base leading-relaxed'>Scale your operations up or down seamlessly. DRC&apos;s flexible workforce and cloud-based tools adapt to your business cycles—whether you&apos;re launching a new product, handling seasonal spikes, or expanding into new markets.</p>
                            </div>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 px-1 md:px-10 mt-6 md:mt-10'>
                        ...
                        <div className='w-full h-auto lg:h-110 border border-gray-100 rounded-3xl overflow-hidden bg-[var(--card-bg)] shadow-lg flex flex-col relative '>
                            ...
                            <div className='flex flex-col gap-4 mb-6 p-6 md:p-8 relative z-10'>
                                <h3 className='text-2xl md:text-3xl font-bold text-[var(--primary-navy)]'>Access to Top Talent</h3>
                                <p className='text-[var(--charcoal)] text-sm md:text-base leading-relaxed'>Tap into a global pool of certified professionals trained in the latest tools and methodologies. From multilingual customer service reps to data scientists, we match the right talent to your unique requirements.</p>
                            </div>
                        ...
                        <div className='w-full h-auto lg:h-110 border border-gray-100 rounded-3xl overflow-hidden bg-[var(--card-bg)] shadow-lg flex flex-col relative'>
                            ...
                            <div className='flex flex-col gap-4 mb-6 p-6 md:p-8 relative z-10'>
                                <h3 className='text-2xl md:text-3xl font-bold text-[var(--primary-navy)]'>Technology Integration</h3>
                                <p className='text-[var(--charcoal)] text-sm md:text-base leading-relaxed'>Our proprietary SaaS platforms—like Smart CRM, Predictive Dialers, and AI-powered QA tools—integrate effortlessly with your existing systems, providing real-time insights, automation, and enhanced productivity.</p>
                            </div>
