...
import { Cost,Group,AccessTopTalent,TechnologyIntegration } from '@/app/static/icons';

const Details = () => {
    return (
    <section className="py-20 px-4 md:px-8 lg:px-16 bg-gray-950 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6"><span className="text-[#9dffa1]">SaaS & AI</span> Innovations Hub </h2>
            <p className="text-gray-300 text-lg md:text-xl lg:text-2xl max-w-4xl mx-auto leading-relaxed px-4"> Unleashing cutting-edge intelligence to redefine your digital frontier. </p>
          ...
          <div className='w-full max-w-7xl mx-auto px-4 md:px-8 '>          
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 px-1 md:px-10'>
                  ...
                  <div className='w-full h-auto lg:h-110 border border-[#5a854d] rounded-3xl overflow-hidden bg-gradient-to-br from-green-900/15 via-gray-900/40 to-gray-950 flex flex-col relative'>
                      ...
                      <div className='absolute inset-0 bg-gradient-to-tl from-[#345035] via-[#101511] to-[#0b0f0e] pointer-events-none animate-pulse-shadow '></div>

                      <div className='flex flex-col gap-4 mb-6 p-6 md:p-8 relative z-10'>
                          <h3 className=' text-2xl md:text-3xl font-bold text-[#d2d2d2]'>Cost Optimization</h3>
                          <p className='text-[#d2d2d2] text-sm md:text-base leading-relaxed'>Our BPO services reduce overhead by up to 40%, leveraging skilled talent in cost-effective locations while maintaining 24/7 service quality. Pay only for what you need—no hidden costs, no infrastructure expenses.</p>
                      </div>
                  ...
                  {/*  Card 2 */}
                  <div className='w-full h-auto lg:h-110 border border-[#5a854d] rounded-3xl overflow-hidden bg-gradient-to-br from-green-900/15 via-gray-900/40 to-gray-950 flex flex-col relative'>
                      <div className='absolute inset-0 bg-gradient-to-tr from-[#345035] via-[#101511] to-[#0b0f0e] pointer-events-none animate-pulse-shadow'></div>
                      
                      
                      <div className='flex flex-col gap-4 mb-6 p-6 md:p-8 relative z-10'>
                          <h3 className='text-2xl md:text-3xl font-bold text-[#d2d2d2]'>Scalable Expertise</h3>
                          <p className='text-[#d2d2d2] text-sm md:text-base leading-relaxed'>Scale your operations up or down seamlessly. DRC&apos;s flexible workforce and cloud-based tools adapt to your business cycles—whether you&apos;re launching a new product, handling seasonal spikes, or expanding into new markets.</p>
                      </div>
              ...
              {/* Row 2 & 3 */}
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 px-1 md:px-10 mt-6 md:mt-10'>
                  {/* Card 3 */}
                  <div className='w-full h-auto lg:h-110 border border-[#5a854d] rounded-3xl overflow-hidden bg-gradient-to-br from-green-900/15 via-gray-900/40 to-gray-950 flex flex-col relative '>
                      <div className='absolute inset-0 bg-gradient-to-bl from-[#345035] via-[#101511] to-[#0b0f0e] pointer-events-none animate-pulse-shadow'></div>
                      
                      <div className='flex flex-col gap-4 mb-6 p-6 md:p-8 relative z-10'>
                          <h3 className='text-2xl md:text-3xl font-bold text-[#d2d2d2]'>Access to Top Talent</h3>
                          <p className='text-[#d2d2d2] text-sm md:text-base leading-relaxed'>Tap into a global pool of certified professionals trained in the latest tools and methodologies. From multilingual customer service reps to data scientists, we match the right talent to your unique requirements.</p>
                      </div>
                  ...
                  <div className='w-full h-auto lg:h-110 border border-[#5a854d] rounded-3xl overflow-hidden bg-gradient-to-br from-green-900/15 via-gray-900/40 to-gray-950 flex flex-col relative'>
                      ...
                      <div className='absolute inset-0 bg-gradient-to-br from-[#345035] via-[#101511] to-[#0b0f0e] pointer-events-none animate-pulse-shadow'></div>

                      <div className='flex flex-col gap-4 mb-6 p-6 md:p-8 relative z-10'>
                          <h3 className='text-2xl md:text-3xl font-bold text-[#d2d2d2]'>Technology Integration</h3>
                          <p className='text-[#d2d2d2] text-sm md:text-base leading-relaxed'>Our proprietary SaaS platforms—like Smart CRM, Predictive Dialers, and AI-powered QA tools—integrate effortlessly with your existing systems, providing real-time insights, automation, and enhanced productivity.</p>
                      </div>
