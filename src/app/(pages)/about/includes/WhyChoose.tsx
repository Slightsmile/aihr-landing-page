...
const WhyChoose = () => {
    ...
    return (
          <section className="relative py-12 sm:py-16 md:py-20 px-4 md:px-8 lg:px-16 bg-gray-950">
              ...
              <div className="max-w-6xl mx-auto text-center mb-10 sm:mb-12 md:mb-16">
                  ...
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-5 md:mb-6">Why <span className="text-[#9dffa1]"> Choose </span>DRC</h2>
                  <p className="text-base sm:text-lg md:text-xl text-[#bebec0] max-w-3xl mx-auto px-2 "> Choosing DRC means partnering with an experienced, innovation driven leader offering hybrid excellence  and complete business solutions.</p>
              </div>
              ...
              <div className="flex justify-center mt-10 sm:mt-12 md:mt-16">
                <div className="p-px bg-linear-to-r from-white to-green-500 rounded-full">

                    <button className="group inline-flex items-center gap-2 md:gap-3 p-[2px] rounded-full bg-linear-to-r from-[#dcdedd] to-[#3eb343] hover:shadow-lg hover:shadow-green-400/50 transition-all duration-300 transform hover:scale-105" onClick={handleLearnMoreClick}>
